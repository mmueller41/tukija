...
Sc::Sc (Pd *own, Ec *e, cpu_t c, Sc *x) : Kobject (SC, static_cast<Space_obj *>(own), 0, 0x1, free_xcpu), ec (e), cpu (c), prio ((x->prio+32U) > static_cast<uint16>(127)? static_cast<uint16>(127): x->prio+32), budget (x->budget), left (x->left)
{
